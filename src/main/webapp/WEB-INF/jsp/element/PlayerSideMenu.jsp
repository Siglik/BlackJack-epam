...
<nav class="left-menu column-left sidebar" id="left-menu">
	<ul class="vertical-menu top">
		<c:if test="${inGame}">
			<li><a href='/blackjack/$/game/leave' class='button leave-game'><fmt:message
						key='button.leavegame' /></a>
		</c:if>
		<li><a href="/blackjack/$/" class="button menu-item"><fmt:message
					key="menu.homepage" /></a></li>
		<c:choose>
		...
		<li><a href="/blackjack/$/game/rules" class="button menu-item"><fmt:message
					key="menu.rules" /></a></li>
	</ul>
